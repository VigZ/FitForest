...
class StoreFrontTabBar: UIView {
    ...
    private func createView() {
        ...
        collectionView.register(StoreTabCell.self, forCellWithReuseIdentifier: "StoreTabCell")
...
extension StoreFrontTabBar: UICollectionViewDelegate, UICollectionViewDataSource {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return tabs.count
    }
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "StoreTabCell", for: indexPath) as? StoreTabCell else {
            return UICollectionViewCell()
        }
        cell.tabViewModel = StoreTab(icon: tabs[indexPath.item].icon, title: tabs[indexPath.item].title)
...
extension StoreFrontTabBar: UICollectionViewDelegateFlowLayout {
